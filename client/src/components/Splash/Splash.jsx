      ...
      <section className="splash-container">
        <Container className="splash-page" id="splash">
          ...
          <Container className="splash-description">
            <Row>
              <Col>
                <img src={JobSearch} alt="computer image" />
              </Col>
              <Col>
                <h3>Job Search Functionality</h3>
                <p>
                  Lorem ipsum dolor sit amet. Sed debitis distinctio ab maxime
                  repellat sit ipsa galisum id similique voluptatem qui quia aut
                  officia ut nobis facere? Non omnis nostrum At dignissimos
                  omnis est labore nesciunt sit iste totam. Rem debitis quia non
                  doloremque temporibus sit libero facere sit quam labore vel
                  pariatur odio.{" "}
                </p>
              </Col>
            </Row>
